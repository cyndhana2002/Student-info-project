...
class others extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/other/Others', value, { headers, withCredentials: true, responseType: 'arraybuffer' });
      ...
      const fontSize = 14;
      const heading = `F.No : DEAN/CEG/BF/OTHER/${this.state.fno}/65`;
      const date = `Dated:`;
...
export default withAuthentication(others);
