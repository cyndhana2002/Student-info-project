...
class Passportrenewnal extends Component {
  state = {
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/pass/passwordren', value, { headers, withCredentials: true, responseType: 'arraybuffer' });
      ...
      const fontSize = 14;
      const heading = `F.No : DEAN/CEG/BF/BKLN/${this.state.fno}/120`;
      const date = `Dated:`;
...
export default withAuthentication(Passportrenewnal);
