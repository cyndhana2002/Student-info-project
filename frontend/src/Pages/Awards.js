 ...
 class Awards extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/award/generateaward', value, { headers, withCredentials: true, responseType: 'arraybuffer' });
      ...
      const heading = `DEAN/CEG/BF/AWARD/${this.state.fno}/183`;
      const date = `Dated:`;
  ...
  render() {
    return (
      ...
      <Card className='centercard' style={{backgroundColor:"rgb(237, 233, 233)"}}>
        <br/>
    <p><b>  Enter Awards and details below: </b></p>
...
export default withAuthentication(Awards);