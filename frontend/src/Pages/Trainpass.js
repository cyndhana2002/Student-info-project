...
class Trainpass extends Component {
  state = {
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/trainpass/Train', value, { headers, withCredentials: true, responseType: 'arraybuffer' });
      ...
      const fontSize = 14;
      const heading = `F.No : DEAN/CEG/BF/BKLN/${this.state.fno}/40`;
      const date = `Dated:`;
...
export default withAuthentication(Trainpass);
