...
class Scholarship extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/scholar/generatescholar', value, { headers, withCredentials: true, responseType: 'arraybuffer' });
      ...
      const fontSize = 14;
      const heading = `F.No : DEAN/CEG/BF/BKLN/${this.state.fno}/875`;
      const date = `Dated:`;
  ...
  render() {
    return (
      ...
      <Card className='incomecard' style={{backgroundColor:"rgb(237, 233, 233)",height:"400px"}}>
        <br/>
        <Label className="name">Type the Scholarship content Here:</Label>
...
export default withAuthentication(Scholarship);