...
class Bus extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/bus/generate', value, { headers, withCredentials: true, responseType: 'arraybuffer' });
      ...
      const fontSize = 14;
      const heading = `F.No : DEAN/CEG/BF/BP/${this.state.fno}/65`;
      const date = `Dated:`;
...
export default withAuthentication(Bus);
